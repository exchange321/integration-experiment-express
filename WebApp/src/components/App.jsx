...
render()
{
    ...
    className = "container" >
        < header >
        < span
    className = "icn-logo" > < i
    className = "material-icons" > code < / i > < / span >
        < ul
    className = "main-nav" >
        < li > < NavLink
    to = "/" > Home < / NavLink > < / li >
    ...
    to = "/about" > About < / NavLink > < / li >
        < li > < NavLink
    to = "/teachers" > Teachers < / NavLink > < / li >
        < li > < NavLink
    to = "/courses" > Courses < / NavLink > < / li >
        {React.createElement(VisibleToGuest(() => < li > < NavLink
    to = "/login" > Login < / NavLink > < / li >
))
}
    {
        React.createElement(VisibleToUser(() => < li > < NavLink
